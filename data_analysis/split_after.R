...
#         }
      ...
      # print(batter_faced)
      if (batter_faced <= 18) {
        pitches_2rotation <- total_pitches
        Player_before2 <- rbind(Player_before2,game[1:total_pitches,])
      } else {
        Player_before2 <- rbind(Player_before2,game[1:pitches_2rotation, ])
        Player_after2 <- rbind(Player_after2, game[(pitches_2rotation+1):total_pitches, ])
        # Player_after2<-rbind(Player_after2,game[(pitches_2rotation+1):pitches_3rotation, ])
